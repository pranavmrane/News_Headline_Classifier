...
class NBClassificationDisplay:

    def __init__(self):
        self.window = Tk()
        self.window.title("NB Classification Window")
        ...
        Label(self.window, text="Naive Bayes - Classification", bg=background_color,
